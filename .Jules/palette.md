...
## 2026-03-21 - CLI Iconography Improvement
**Learning:** When strict timing constraints prevent animated UI states, upgrading static ASCII text to distinct Unicode symbols (e.g., [OK] -> [✔]) reduces cognitive load by shifting from reading text to recognizing an icon.
**Action:** Replaced text-based success indicators with Unicode symbols in the CLI loading bar.
