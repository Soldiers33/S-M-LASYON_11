...
from dogrulama_testleri import Modul_DogrulamaTestleri
...
class Simule3_Lab: 
    def __init__(self):
        ...
        # Extended Dynamic Modules
        self.dynamic_dogrulama = Modul_DogrulamaTestleri(const)
        self.nasa_live = Modul_NasaLiveData(const)
        self.deep_research = Modul_DeepResearch(const)
...
class Simule3_Lab_V133(Simule3_Lab):
    ...
    def run_all(self):
        ...
        # Run Extended Modules
        print(f"\n{Colors.BOLD}{Colors.CYAN}*** RUNNING DYNAMIC REAL-TIME VERIFICATION MODULES ***{Colors.ENDC}")
        self.dynamic_dogrulama.analiz()
