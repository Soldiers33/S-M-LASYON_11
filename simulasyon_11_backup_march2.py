...
try:
    ...
    print("[WARNING] levhi_mahfuz.py not found. Running with basic constants only.")
...
class Simule3_Lab_V133(Simule3_Lab):
    ...
    def run_all(self):
        ...
        # ===== LEVH-İ MAHFUZ INTEGRATION =====
        if LEVHI_MAHFUZ_LOADED:
            print(f"\n{Colors.HEADER}{'='*80}{Colors.ENDC}")
            print(f"{Colors.HEADER}>>> LEVH-İ MAHFUZ (Sacred Tablet) VALIDATION <<<{Colors.ENDC}")
            print(f"{Colors.HEADER}{'='*80}{Colors.ENDC}")
            validate_levhi_mahfuz()
            print(f"{Colors.GREEN}Levh-i Mahfuz constants and formulas successfully validated.{Colors.ENDC}")
